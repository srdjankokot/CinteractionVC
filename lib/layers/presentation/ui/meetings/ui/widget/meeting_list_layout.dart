                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                      state.meetings[index].callId.toString(),
                                                      style: context.textTheme
                                                          .titleSmall),
                                                ),
                                                ...
                                                Visibility(
                                                    ...
                                                    child: Text(
                                                        '${state.meetings[index]
                                                            .meetingStart.day}.${state.meetings[index]
                                                            .meetingStart.month}.${state.meetings[index].meetingStart.year}')),
                                              ],
                                            ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                      state.meetings[index].organizer??''),
                                                  const SizedBox(height: 10,),
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        const SizedBox(
                                                          height: 10,),
                                                        EngagementProgress(
                                                          engagement: (state.meetings[index].averageEngagement! * 100).toInt(),
                                                          width: double
                                                              .maxFinite,
                                                        )
                                                      ],
                                                  ...
                                                  Visibility(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                            'Start: ${state.meetings[index]
                                                                .meetingStart.hour}:${state.meetings[index].meetingStart.minute}'),
                                                        const SizedBox(
                                                          height: 10,),
                                                        Text(
                                                            'Start: ${state.meetings[index]
                                                                .meetingEnd?.hour}:${state.meetings[index].meetingEnd?.minute}'),
                                                      ],
                                                    ),
                                                  ),

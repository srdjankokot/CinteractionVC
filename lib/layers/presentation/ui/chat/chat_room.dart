...
class ChatRoomPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<dynamic> showIncomingCallDialog(BuildContext context, String caller) async {
                      ...
                      child: Padding(
                        ...
                        child: () {
                          ...
                          if(state.localStream!=null)
                          {
                            ...
                            {
                              return getRendererItem(context, state.localStream!, double.maxFinite, double.maxFinite);
                            }
                            else
                            {
                              ...
                              return Stack(
                                children: [
                                  getRendererItem(context, state.remoteStream!, double.maxFinite, double.maxFinite),
                                  getRendererItem(context, state.localStream!, 200, 200),
                                    ...
                                    child:   Row(
                                      children: [
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(state.currentParticipant!.display, style: titleThemeStyle.textTheme.titleLarge,),
                                            Row(
                                              children: [
                                                Container(
                                                ...
                                                Text("Active now", style: titleThemeStyle.textTheme.labelLarge,),
                                              ],
                                            )
                                        ...
                                        CallButtonShape(
                                          ...
                                          bgColor: ColorConstants.kPrimaryColor,
                                          onClickAction: () async {
                                            await context.read<ChatCubit>().makeCall(state.currentParticipant!.display);
                                          },
                                        )
                                      ],
                                    ),

      ...
      return SizedBox(
        ...
        child: LayoutBuilder(builder: (context, constraints) {
          final halfHeight = min(constraints.maxHeight, constraints.maxWidth)  / 3;
                ...
                var screenShare = state.videoRenderer!.publisherName.toLowerCase().contains('screenshare');
                            ...
                            replacement: Container(
                                decoration: BoxDecoration(
                                  ...
                                  gradient: RadialGradient(
                                    ...
                                    radius: 0.6,
                                    colors: [
                                      ColorConstants.getRandomColor(state.publisherId),
                                      ColorConstants.getRandomColor(state.publisherId, shade: 700),
                                    ],
                                  ),
                                  border: Border.all(
                                ...
                                child: Center(
                                    child: UserImage.size([state.videoRenderer!.getUserImageDTO()], halfHeight, 700))),
                            child:
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        ...
                                        width: state.isSpeaking ? 2.0 : 0.0, // Border thickness
                                      ),

...
class VideoRoomPageOld extends StatefulWidget {
  final int room;
  final String displayName;

  const VideoRoomPageOld({super.key, required this.room, required this.displayName});

  @override
  State<VideoRoomPageOld> createState() => _VideoRoomPage();
}

class _VideoRoomPage extends State<VideoRoomPageOld> {
  late int room;
